...
//        dm.enqueue(request);
    ...
    public static void datePopup(Context context, final TextView text, DateTimeSelectedInterface iFace) {
    ...
    public static void timePopup(Context context, final TextView text, DateTimeSelectedInterface iFace) {
    ...
    public static void timePopup(Context context, DateTimeSelectedInterface iFace) {
    ...
    public static void timePopup(Context context, long defaultDateMillis, DateTimeSelectedInterface iFace) {
...
//        bm.recycle();
    ...
    public static ArrayList<MultipartBody.Part> getMultiPartBodyList(String paramName, File file) {
        ArrayList<File> list = new ArrayList<>();
        list.add(file);
        return getMultiPartBodyList(paramName, list);
    }
...
//    public static void setLinearRecycler(Context mContext, RecyclerView recyclerCertificate, boolean AddSeperator) {
//        LinearLayoutManager lm = new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false);
//        recyclerCertificate.setLayoutManager(lm);
//        if (AddSeperator)
//            recyclerCertificate.addItemDecoration(new VerticalSpaceItemDecoration(mContext.getResources().getDimension(R.dimen.listview_vertical_space)));
//    }
    ...
    public static LatLngBounds getLatLngBounds(LocationItem... locations) {
        LatLngBounds.Builder builder = LatLngBounds.builder();
        for (LocationItem loc : locations)
            builder.include(new LatLng(Double.parseDouble(loc.latitude), Double.parseDouble(loc.longitude)));
        return builder.build();
    }

    public static LatLngBounds getLatLngBounds(LatLng origin, ArrayList<LocationItem> locations) {
        LatLngBounds.Builder builder = LatLngBounds.builder();
